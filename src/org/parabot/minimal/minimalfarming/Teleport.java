...
public enum Teleport
{
    ...
    public void Teleport() {
        ...
        Time.sleep(250);
        if(list2 != 0) { sendAction(destId, list2); Time.sleep(1000); }
        if(list3 != 0) { sendAction(destId, list3); Time.sleep(1000); }
        if(list4 != 0) { sendAction(destId, list4); Time.sleep(1000); }
